...
class HandleCollisionsAction(Action):
    ...
    def execute(self, cast, script):
        ...
        """
        if not self._player_one_win or not self._player_two_win:
    ...
    def _handle_food_collision(self, cast):
        ...
        if head2.get_position().equals(food.get_position()):
            ...
            score2.add_points(points,'red snake')
            food.reset()

        if head.get_position().equals(food.get_position()):
            points = food.get_points()
            snake.grow_tail(points)
            score1.add_points(points, 'green snake')
            food.reset()
    ...
    def _handle_game_over(self, cast):
        ...
        if self._player_two_win:
            ...
            message = Actor()
            message.set_text("Red snake won!")
        ...
        if self._player_one_win:
            ...
            message = Actor()
            message.set_text("Green snake won!")
            message.set_position(position)
            cast.add_actor("messages", message)
