...
class Pacman(Actor):
    ...
    def swing_left(self):
        ...
        self._animation = Animation(PACMAN_IMAGES_LEFT, PACMAN_RATE)

    def swing_right(self):
        """Steers the bat to the right."""
        velocity = Point(PACMAN_VELOCITY, 0)
        self._body.set_velocity(velocity)
        self._animation = Animation(PACMAN_IMAGES_RIGHT, PACMAN_RATE)
    ...
    def swing_up(self):
        ...
        self._body.set_velocity(velocity)
        self._animation = Animation(PACMAN_IMAGES_UP, PACMAN_RATE)

    def swing_down(self):
        """Steers the bat to the right."""
        velocity = Point(0, PACMAN_VELOCITY)
        self._body.set_velocity(velocity)
        self._animation = Animation(PACMAN_IMAGES_DOWN, PACMAN_RATE)